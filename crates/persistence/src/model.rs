...
use super::schema::{
    active_mcp_servers, ai_memory_panes, ambient_agent_panes, app, blocks, cloud_objects_refreshes,
    code_pane_tabs, code_panes, code_review_panes, commands, current_user_information,
