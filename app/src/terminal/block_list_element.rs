...
use super::view::{
    BLOCK_BANNER_HEIGHT, InlineBannerId, SeparatorId, SharedSessionBanners, TerminalEditor,
...
impl BlockListElement {
    ...
    where
        I: IntoIterator<Item = (EntityId, Box<dyn Element>)>,
    {
        self.rich_content_elements.extend(content);
        self
    }
