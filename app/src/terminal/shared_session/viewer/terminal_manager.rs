...
use session_sharing_protocol::common::{
    ...
    LinkAccessLevelUpdateResponse, RemoveGuestResponse, SessionId, TeamAccessLevelUpdateResponse,
...
use super::network::{
    Network, NetworkEvent, command_execution_failure_reason_string, session_ended_reason_string,
...
enum NetworkState {
    /// No viewer network is attached yet.
    Idle,
