...
/// Historical object kinds used to decode local SQLite IDs.
...
impl ObjectIdType {
    pub fn sqlite_prefix(self) -> &'static str {
        match self {
            ...
            Self::Folder => "Folder",
            Self::GenericStringObject => "GenericStringObject",
        }
    }
}
...
/// Implements historical string and hash forms for typed server IDs.
#[macro_export]
