...
use crate::code_review::diff_types::AgentReviewCommentBatch;
...
use crate::workspace::view::{
    MAX_SIDEBAR_WIDTH_RATIO, MIN_SIDEBAR_WIDTH, TOGGLE_RIGHT_PANEL_BINDING_NAME,
};
...
impl ReviewTerminalUnavailableReason {
    fn label(&self) -> &'static str {
        match self {
            ...
            Self::NoCliAgent => "no CLI agent is running in the terminal",
        }
    }
}
...
impl RightPanelView {
    ...
    fn review_terminal_status(
        ...
        tv.read(ctx, |t, ctx| {
            ...
            if active_cli_agent.is_none() {
                unavailable_reasons.push(ReviewTerminalUnavailableReason::NoCliAgent);
            }
    ...
    /// review comments, i.e. it has an active CLI agent.
